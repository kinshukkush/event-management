...
<div class="max-w-5xl mx-auto p-6">
    ...
    @else
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div class="bg-white dark:bg-gray-800 dark:text-white shadow-md rounded-2xl p-5 border border-gray-200 dark:border-gray-700 transition transform hover:scale-105 hover:shadow-xl hover:border-blue-400 duration-300 animate__animated animate__fadeInUp flex flex-col">
    ...
    <p class="text-gray-600 dark:text-gray-300 mt-1">{{ $booking->event->description }}</p>
