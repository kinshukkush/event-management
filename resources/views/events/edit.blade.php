...
<div class="max-w-3xl mx-auto mt-10 px-4">
    <h2 class="text-3xl font-semibold mb-8 text-gray-1000">Edit Event</h2>
    ...
    <form action="{{ route('events.update', $event) }}" method="POST" enctype="multipart/form-data" class="space-y-6 bg-white p-6 rounded-lg shadow">
        ...
        <div>
            ...
            <input type="text" name="title" value="{{ $event->title }}" class="w-full border border-gray-300 rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-pink-1000" required>
        </div>

        <div>
            <label class="block text-gray-1000 mb-2">Description</label>
        ...
        <div>
            ...
            <input type="text" name="location" value="{{ $event->location }}" class="w-full border border-gray-1000 rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-pink-500" required>
        </div>
